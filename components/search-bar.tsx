    ...
    return (
      <div className="relative flex-1 max-w-md">
        ...
        <input
          ...
          className="h-9 w-full rounded-lg border border-[#091413]/15 bg-white pl-9 pr-14 text-[14px] leading-[23.8px] text-[#091413] placeholder-[#091413]/40 outline-none transition-colors focus:border-brand-500 focus:ring-1 focus:ring-brand-500/50 dark:border-white/15 dark:bg-white/5 dark:text-white dark:placeholder-white/40 dark:focus:border-brand-500"
        />
        {query ? (
          <button
            onClick={() => onChange('')}
            className="absolute right-2 top-1/2 -translate-y-1/2 rounded p-0.5 text-[#091413]/40 hover:text-[#091413]/70 dark:hover:text-white/80"
          >
            <X size={14} />
          </button>
        ) : (
