    ...
    <aside className="flex h-full w-72 flex-col border-r border-gray-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
        ...
        {creating && (
          <div className="flex items-center gap-2 rounded-lg px-3 py-2">
            <input
              ...
              className="flex-1 min-w-0 rounded bg-transparent text-sm outline-none placeholder-zinc-500"
            />
          </div>
        )}
      </div>
      ...
      <div className="border-t border-gray-200 p-2 dark:border-zinc-800">
        <button
          ...
          className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm text-gray-500 transition-colors hover:bg-gray-100 dark:text-zinc-400 dark:hover:bg-zinc-800"
        >
          <FolderPlus size={16} />
          New Folder
        </button>
